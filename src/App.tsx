      ...
      <header className="max-w-3xl mx-auto mb-8 border-b border-neutral-800 pb-4 flex justify-between items-center">
        ...
        {user ? (
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => signInWithEmailAndPassword(auth, email, password)} className="bg-blue-600 px-3 py-1 text-xs rounded flex items-center gap-1"><LogIn size={14} />Giriş</button>
          </div>
        )}
      </header>
